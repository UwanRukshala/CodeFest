...
import com.codefestfinal.codefest21_2.Model.Admin;
import com.codefestfinal.codefest21_2.databinding.FragmentSignUpBinding;
...
//                    uploadImage(String firstName, String lastName, String nic, String mobile, String gender, String email)
    ...
    private void uploadImage(String firstName, String lastName, String nic, String mobile, String gender, String email) {
        ...
        startProgress();
        storageRef.child("Admins").child(userNameImage).putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
                ...
                taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Admin user = new Admin(firstName, lastName, nic, mobile, email, gender, downloadUrl.toString(), null);

                            db.collection("Admins").add(user).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                @Override
